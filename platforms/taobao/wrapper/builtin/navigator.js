...
const taobaoVersioin = systemInfo.version;
...
const ua = `Mozilla/5.0 (${uaDesc}) AppleWebKit/603.1.30 (KHTML, like Gecko) Mobile/14E8301 ChannelId(0) Nebula  AlipayDefined() AliApp(AP/${taobaoVersioin}) AlipayClient/${taobaoVersioin} AlipayIDE Taobao/11457110/Worker/1.13.7 NetType/WIFI Language/${language}`;
const navigator = {
  platform,
  language: language,
